...
""" [ 확인 ]
    1- 문자열 끝까지라면 두번째 숫자 생략 가능   ex) msg[2:]
    2- 처음부터 시작하는 것이라면 첫번째 숫자 생략 가능 ex ) msg[:5]
"""
msg ='오늘도 행복도 하다'
# 1) 5번째부터
print(msg[5:])
...
print(msg[0:4] + '년' + msg[5:7] + '월')
date = '2020-02-22'
time = '12:05:12'
print(date[0:4],"년",date[5:7],'월',date[8:10],'일')
print(time[0:2],"시",time[3:5],"분")
# -----------------------------------------
#  (4-1) 문자열 관련 함수
...
"""
find는 찾는 문자나 문자열이 없다면 -1 리턴
index는 찾는 문자나 문자열이 없다면 에러
"""
